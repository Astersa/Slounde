...
<body>
    <div class="container-fluid p-0">
        <div class="row g-0">
            ...
            <div class="col-lg-10 col-md-9 ms-auto main-content">
                ...
                <!-- Include Sidebar -->
                <jsp:include page="/WEB-INF/common/search-and-user.jsp" />
    ...
    <script src="js/recently-play.js"></script>
...
// Function to load content dynamically
        function loadContent(path) {
            // If path contains query parameters, preserve them
            const [basePath, queryString] = path.split('?');
            let url = basePath + '?ajax=true';
