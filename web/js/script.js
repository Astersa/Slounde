  ...
  musicCards.forEach((card) => {
    card.addEventListener("click", function () {
      ...
      const songData = {
        ...
        thumbnailUrl: this.getAttribute("data-cover"),
        audioUrl: this.getAttribute("data-audio"),
        name: this.querySelector("h6").textContent,
        artistName: this.querySelector("p").textContent,
        streams: this.querySelector(".card-label").textContent,
        isLiked: this.querySelector(".islike").textContent,
      };
      ...
      const duplicateIndex = playlist.findIndex(
